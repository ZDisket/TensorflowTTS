...
def main():
    ...
    parser.add_argument(
       "--trim",
        default="n",
        type=str,
        help="Whether to apply MFA-based trimming to source audio and ignore end and start silences",
    )
    parser.add_argument(
       "--round",
        default="y",
    ...
    parser.add_argument(
       "--no-bracket",
        default="n",
        type=str,
        help="Whether to NOT add curly braces to delimit phonetic input",
    )
