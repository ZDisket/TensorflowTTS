...
from tensorflow_tts.processor import SpanishProcessor
...
from tensorflow_tts.processor.spanish import SPANISH_SYMBOLS
...
def parse_and_config():
    ...
    parser.add_argument(
        ...
        type=str,
        default="ljspeech",
        choices=["ljspeech", "kss", "libritts", "baker","spanish"],
